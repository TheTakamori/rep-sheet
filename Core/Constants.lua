...
ns.ADDON_NAME = "RepSheet"
ns.ADDON_METADATA_VERSION_KEY = "Version"
ns.LOCAL_DEV = ns.LOCAL_DEV or {
	ENABLE_DEBUG = false,
}
ns.ALL_EXPANSIONS_KEY = "all"
ns.DEFAULT_MINIMAP_BUTTON_ANGLE = 225
...
ns.TEXT = {
	...
	FORGET_ALT_INFO = "Remove the selected alt's saved Rep Sheet data. This does not delete the WoW character. The data will return if that character logs in and scans again.",
	...
	CLEAR_ALL_DATA_CONFIRM = "Delete all saved Rep Sheet reputation data for every character?",
	...
	PROGRESS_BAR_TOOLTIP_OVERALL = "Orange: Overall progress toward finishing the reputation.",
	PROGRESS_BAR_TOOLTIP_BAND = "Blue: Progress within the current rank or renown level.",
